resource "aws_instance" "jbOxm" {
  ...
  instance_type        = var.aws_instance_jbOxm_instance_type
  key_name             = "cycloid"
  metadata_options {
...
resource "aws_instance" "nfibD" {
  ...
  instance_type        = var.aws_instance_nfibD_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "vgnMd" {
  ...
  iam_instance_profile = "cycloid_profile-front-cycloidio-website-prod"
  instance_type        = var.aws_instance_vgnMd_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_launch_configuration" "DKalQ" {
  ebs_block_device {
    delete_on_termination = true
...
resource "aws_launch_configuration" "KObYl" {
  ebs_block_device {
    delete_on_termination = true
    device_name           = "/dev/xvdf"
    volume_size           = 150
...
resource "aws_launch_configuration" "KlNgK" {
  ebs_block_device {
    delete_on_termination = true
    device_name           = "/dev/xvdf"
    volume_size           = 150
...
resource "aws_launch_configuration" "RokYx" {
  ebs_block_device {
    delete_on_termination = true
    device_name           = "/dev/xvdf"
    volume_size           = 150
...
resource "aws_launch_configuration" "jRbws" {
  enable_monitoring = true
...
resource "aws_launch_template" "OHccv" {
  tags = {
...
resource "aws_launch_template" "PpBWu" {
  tags = {
