resource "aws_instance" "fqbSp" {
  ...
  instance_type        = var.aws_instance_fqbSp_instance_type
  key_name             = "cycloid"
  metadata_options {
...
resource "aws_instance" "kknmb" {
  ...
  iam_instance_profile = "cycloid_profile-front-cycloidio-website-prod"
  instance_type        = var.aws_instance_kknmb_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "qXpEp" {
  ...
  instance_type        = var.aws_instance_qXpEp_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_launch_configuration" "BDxRa" {
...
resource "aws_launch_configuration" "OTPuO" {
  ebs_block_device {
    delete_on_termination = true
...
resource "aws_launch_configuration" "XvmRo" {
  ebs_block_device {
    delete_on_termination = true
    device_name           = "/dev/xvdf"
    volume_size           = 150
...
resource "aws_launch_configuration" "aiPCs" {
  ebs_block_device {
    delete_on_termination = true
    device_name           = "/dev/xvdf"
    volume_size           = 150
...
resource "aws_launch_configuration" "wXKPf" {
  ebs_block_device {
    delete_on_termination = true
    device_name           = "/dev/xvdf"
    volume_size           = 150
...
resource "aws_launch_template" "PWBZQ" {
  tags = {
...
resource "aws_launch_template" "gYqPP" {
  tags = {
