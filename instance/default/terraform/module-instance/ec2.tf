resource "aws_instance" "QpUVi" {
  ...
  instance_type                        = var.aws_instance_QpUVi_instance_type
  key_name                             = "cycloid"
  metadata_options {
...
resource "aws_instance" "UxVJk" {
  ...
  instance_type                        = var.aws_instance_UxVJk_instance_type
  key_name                             = "demo"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "bPTCo" {
  ...
  iam_instance_profile                 = "profile-worker-external-worker-prod"
  instance_initiated_shutdown_behavior = "terminate"
  instance_type                        = var.aws_instance_bPTCo_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "euuFu" {
  ...
  instance_initiated_shutdown_behavior = "stop"
  instance_type                        = var.aws_instance_euuFu_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "faydk" {
  ...
  instance_initiated_shutdown_behavior = "stop"
  instance_type                        = var.aws_instance_faydk_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "iihzG" {
  ...
  instance_initiated_shutdown_behavior = "stop"
  instance_type                        = var.aws_instance_iihzG_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "kzdeP" {
  ...
  iam_instance_profile                 = "profile-worker-external-worker-prod"
  instance_initiated_shutdown_behavior = "terminate"
  instance_type                        = var.aws_instance_kzdeP_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "lHhWE" {
  ...
  instance_initiated_shutdown_behavior = "stop"
  instance_type                        = var.aws_instance_lHhWE_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "mfaBC" {
  ...
  iam_instance_profile                 = "cycloid_profile-front-cycloidio-website-prod"
  instance_initiated_shutdown_behavior = "stop"
  instance_type                        = var.aws_instance_mfaBC_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "rHQBH" {
  ...
  iam_instance_profile                 = "profile-worker-external-worker-prod"
  instance_initiated_shutdown_behavior = "terminate"
  instance_type                        = var.aws_instance_rHQBH_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "sESbj" {
  ...
  instance_initiated_shutdown_behavior = "stop"
  instance_type                        = var.aws_instance_sESbj_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "sFVAU" {
  ...
  iam_instance_profile                 = "infra_profile"
  instance_initiated_shutdown_behavior = "stop"
  instance_type                        = var.aws_instance_sFVAU_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "uYDGF" {
  ...
  instance_initiated_shutdown_behavior = "stop"
  instance_type                        = var.aws_instance_uYDGF_instance_type
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
    http_tokens                 = "optional"
...
resource "aws_instance" "yExDG" {
  ...
  instance_initiated_shutdown_behavior = "stop"
  instance_type                        = var.aws_instance_yExDG_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "yuJBv" {
  ...
  disable_api_termination              = true
  instance_initiated_shutdown_behavior = "stop"
  instance_type                        = var.aws_instance_yuJBv_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
