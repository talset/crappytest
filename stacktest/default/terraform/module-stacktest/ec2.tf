resource "aws_instance" "BnLPF" {
  tags = {
    Name                 = "onprem-florian-cy_instances-0-infra-import"
    client               = "cycloid-sandbox"
    "cycloid.io"         = aws_cloudfront_distribution.XnfPC.enabled
    env                  = "infra-import"
