resource "aws_instance" "DruQA" {
  ...
  tags_all = {
    Name         = "cycloidio-website-front-prod"
    client       = "cycloid"
    "cycloid.io" = aws_cloudfront_distribution.mQQtv.enabled
    env          = "prod"
    project      = "cycloidio-website"
    role         = "front"
  }
