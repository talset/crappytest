resource "aws_instance" "CulfI" {
  ...
  ami                         = var.aws_instance_culfi_ami
...
resource "aws_instance" "JcVif" {
  ...
  ami                  = var.aws_instance_jcvif_ami
...
resource "aws_instance" "TyDUh" {
  ...
  ami                         = var.aws_instance_tyduh_ami
  associate_public_ip_address = true
  availability_zone           = "eu-west-1b"
  cpu_core_count              = 4
  cpu_threads_per_core        = 2
...
resource "aws_instance" "lHvnE" {
  ...
  ami                         = var.aws_instance_lhvne_ami
  associate_public_ip_address = true
  availability_zone           = "eu-west-1b"
  cpu_core_count              = 4
  cpu_threads_per_core        = 2
