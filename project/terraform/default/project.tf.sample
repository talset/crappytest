module "project" {
  ...
  # aws_instance_ckvbk_instance_type                                                                    = "t3.small"
  ...
  # aws_instance_ivaia_instance_type                                                                    = "c5.2xlarge"
  # aws_instance_kqmld_instance_type                                                                    = "c5.2xlarge"
  ...
  # aws_instance_otzrf_instance_type                                                                    = "c5.2xlarge"
