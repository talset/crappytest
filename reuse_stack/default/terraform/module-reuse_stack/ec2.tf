resource "aws_instance" "AwEVN" {
  ...
  instance_type        = var.aws_instance_AwEVN_instance_type
  key_name             = "cycloid"
  metadata_options {
...
resource "aws_instance" "CxeMZ" {
  ...
  instance_type               = var.aws_instance_CxeMZ_instance_type
  key_name                    = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "OUvKc" {
  ...
  instance_type        = var.aws_instance_OUvKc_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "OWNjb" {
  ...
  instance_type        = var.aws_instance_OWNjb_instance_type
  key_name             = "demo"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "POFVa" {
  ...
  instance_type        = var.aws_instance_POFVa_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "TWIHr" {
  ...
  iam_instance_profile = "cycloid_profile-front-cycloidio-website-prod"
  instance_type        = var.aws_instance_TWIHr_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "UqKjc" {
  ...
  disable_api_termination = true
  instance_type           = var.aws_instance_UqKjc_instance_type
  key_name                = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "VEems" {
  ...
  ebs_optimized        = true
  iam_instance_profile = "profile-worker-external-worker-prod"
  instance_type        = var.aws_instance_VEems_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "VbdpM" {
  ...
  instance_type           = var.aws_instance_VbdpM_instance_type
  key_name                = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "VsVvN" {
  ...
  instance_type        = var.aws_instance_VsVvN_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "dOjZH" {
  ...
  disable_api_termination = true
  iam_instance_profile    = "infra_profile"
  instance_type           = var.aws_instance_dOjZH_instance_type
  key_name                = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "gbewb" {
  ...
  instance_type        = var.aws_instance_gbewb_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "qFyPd" {
  ...
  ebs_optimized        = true
  iam_instance_profile = "profile-worker-external-worker-prod"
  instance_type        = var.aws_instance_qFyPd_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "vdZrP" {
  ...
  ebs_optimized        = true
  iam_instance_profile = "profile-worker-external-worker-prod"
  instance_type        = var.aws_instance_vdZrP_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
