resource "aws_instance" "CNBMe" {
  ...
  instance_type        = var.aws_instance_CNBMe_instance_type
  key_name             = "cycloid"
  metadata_options {
...
resource "aws_instance" "HQGdX" {
  ...
  instance_type               = var.aws_instance_HQGdX_instance_type
  key_name                    = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "MnruO" {
  ...
  instance_type           = var.aws_instance_MnruO_instance_type
  key_name                = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "NMYrs" {
  ...
  disable_api_termination = true
  instance_type           = var.aws_instance_NMYrs_instance_type
  key_name                = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "RqsRN" {
  ...
  instance_type        = var.aws_instance_RqsRN_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "XCokC" {
  ...
  ebs_optimized        = true
  iam_instance_profile = "profile-worker-external-worker-prod"
  instance_type        = var.aws_instance_XCokC_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "YUAtO" {
  ...
  instance_type        = var.aws_instance_YUAtO_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "Yipjs" {
  ...
  iam_instance_profile = "cycloid_profile-front-cycloidio-website-prod"
  instance_type        = var.aws_instance_Yipjs_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "ZtUXm" {
  ...
  instance_type        = var.aws_instance_ZtUXm_instance_type
  key_name             = "demo"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "kuYbn" {
  ...
  disable_api_termination = true
  iam_instance_profile    = "infra_profile"
  instance_type           = var.aws_instance_kuYbn_instance_type
  key_name                = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "myoRi" {
  ...
  instance_type        = var.aws_instance_myoRi_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "rdECc" {
  ...
  ebs_optimized        = true
  iam_instance_profile = "profile-worker-external-worker-prod"
  instance_type        = var.aws_instance_rdECc_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "uOwBi" {
  ...
  ebs_optimized        = true
  iam_instance_profile = "profile-worker-external-worker-prod"
  instance_type        = var.aws_instance_uOwBi_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "ugeVa" {
  ...
  instance_type        = var.aws_instance_ugeVa_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
