resource "aws_instance" "BmtNe" {
  ...
  instance_type        = var.aws_instance_BmtNe_instance_type
  key_name             = "cycloid"
  metadata_options {
...
resource "aws_instance" "Bqpmk" {
  ...
  instance_type           = var.aws_instance_Bqpmk_instance_type
  key_name                = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "BuNZL" {
  ...
  instance_type           = var.aws_instance_BuNZL_instance_type
  key_name                = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "Edanj" {
  ...
  instance_type        = var.aws_instance_Edanj_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "JSXaV" {
  ...
  disable_api_termination = true
  iam_instance_profile    = "infra_profile"
  instance_type           = var.aws_instance_JSXaV_instance_type
  key_name                = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "LhWyi" {
  ...
  instance_type        = var.aws_instance_LhWyi_instance_type
  key_name             = "demo"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "MPjYj" {
  ...
  instance_type        = var.aws_instance_MPjYj_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "RMbWJ" {
  ...
  iam_instance_profile = "cycloid_profile-front-cycloidio-website-prod"
  instance_type        = var.aws_instance_RMbWJ_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "TMSOb" {
  ...
  ebs_optimized        = true
  iam_instance_profile = "profile-worker-external-worker-prod"
  instance_type        = var.aws_instance_TMSOb_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "UJEZY" {
  ...
  instance_type        = var.aws_instance_UJEZY_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "WeKMK" {
  ...
  cpu_threads_per_core        = 1
  disable_api_termination     = true
  instance_type               = var.aws_instance_WeKMK_instance_type
  key_name                    = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "YnhJE" {
  ...
  instance_type        = var.aws_instance_YnhJE_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "jOjZB" {
  ...
  ebs_optimized        = true
  iam_instance_profile = "profile-worker-external-worker-prod"
  instance_type        = var.aws_instance_jOjZB_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "sKVpd" {
  ...
  ebs_optimized        = true
  iam_instance_profile = "profile-worker-external-worker-prod"
  instance_type        = var.aws_instance_sKVpd_instance_type
  key_name             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
