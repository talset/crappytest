resource "aws_instance" "LlBqM" {
  ...
  ami                         = var.aws_instance_llbqm_ami
  ...
  instance_type                        = var.aws_instance_llbqm_instance_type
  key_name                             = "cycloid"
  metadata_options {
...
resource "aws_instance" "WVOCY" {
  ...
  ami                         = var.aws_instance_wvocy_ami
  associate_public_ip_address = true
  ...
  iam_instance_profile                 = "profile-worker-external-worker-prod"
  instance_initiated_shutdown_behavior = "terminate"
  instance_type                        = var.aws_instance_wvocy_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "ZrKmQ" {
  ...
  ami                  = var.aws_instance_zrkmq_ami
  availability_zone    = "eu-west-1b"
  cpu_core_count       = 1
  cpu_threads_per_core = 2
  ...
  instance_type                        = var.aws_instance_zrkmq_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "ltFjU" {
  ...
  ami                         = var.aws_instance_ltfju_ami
  associate_public_ip_address = true
  availability_zone           = "eu-west-1b"
  cpu_core_count              = 4
  cpu_threads_per_core        = 2
  ...
  iam_instance_profile                 = "profile-worker-external-worker-prod"
  instance_initiated_shutdown_behavior = "terminate"
  instance_type                        = var.aws_instance_ltfju_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
