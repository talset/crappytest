resource "aws_instance" "MorKX" {
  ...
  ami                         = var.aws_instance_morkx_ami
  ...
  instance_type                        = var.aws_instance_morkx_instance_type
  key_name                             = "cycloid"
  metadata_options {
...
resource "aws_instance" "ZRRjY" {
  ...
  ami                  = var.aws_instance_zrrjy_ami
  availability_zone    = "eu-west-1b"
  cpu_core_count       = 1
  cpu_threads_per_core = 2
  ...
  instance_type                        = var.aws_instance_zrrjy_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "onprem2_olivier_cy_instances_0_onprem" {
  ...
  tenancy                = "default"
  vpc_security_group_ids = ["sg-12eee674", "sg-023dc23b8139e0643"]
}
...
resource "aws_instance" "vQUmY" {
  ...
  ami                         = var.aws_instance_vqumy_ami
  associate_public_ip_address = true
  ...
  iam_instance_profile                 = "profile-worker-external-worker-prod"
  instance_initiated_shutdown_behavior = "terminate"
  instance_type                        = var.aws_instance_vqumy_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
...
resource "aws_instance" "vzijP" {
  ...
  ami                         = var.aws_instance_vzijp_ami
  associate_public_ip_address = true
  availability_zone           = "eu-west-1b"
  cpu_core_count              = 4
  cpu_threads_per_core        = 2
  ...
  iam_instance_profile                 = "profile-worker-external-worker-prod"
  instance_initiated_shutdown_behavior = "terminate"
  instance_type                        = var.aws_instance_vzijp_instance_type
  key_name                             = "cycloid"
  metadata_options {
    http_endpoint               = "enabled"
    http_put_response_hop_limit = 1
